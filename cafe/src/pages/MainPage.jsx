            ...
            <div className='mainpage-content'>
                ...
                <div className='mainpage-content__stocks'>
                    <div className='mainpage-stocks-div mainpage-stocks-div_right'>
                        ...
                        <img className='mainpage-stocks-div__img' src={StocksLeftImg}></img>
                    </div>
                    <div className='mainpage-stocks-div'>
                        ...
                        <img className='mainpage-stocks-div__img' src={StocksRightImg}></img>
                    </div>
                </div>
                ...
                <div className='mainpage-content__about'>
                    ...
                    <p className='mainpage-about__bestcafe'>Лучшее кафе в Кубинке!<br/>Приходи к нам!</p>
                </div>
                ...
                <div className='mainpage-content__contacts'>
                    ...
                    <div className='mainpage-contacts__arrow'><div></div></div>
                    <p className='mainpage-contacts__info'>Если не можешь прийти, то позвони нам!</p>
                </div>
            </div>
        </div>
      </>
...
export default MainPage;import '../sass/mainpage/main.sass'
import BearMainpage from '../img/Bear-mainpage.svg'
